...
class DataModule {
    @Single
    fun provideHeartRateDao(@Provided dataBase: HramDatabase) = dataBase.getHeartRateDao()

    @Single
    fun provideActivityDao(@Provided database: HramDatabase) = database.getActivityDao()
