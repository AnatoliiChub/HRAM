...
class IosFileExporter : FileExporter {
    ...
    override suspend fun exportData(fileName: String, content: String) {
        withContext(Dispatchers.Main) {
            ...
            // For iPad, we might need popoverPresentationController sourceView/sourceRect,
            // but for now let's hope it works or defaults to center/modal.
            // If it crashes on iPad, we'll need more logic.
