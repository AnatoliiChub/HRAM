...
import com.achub.hram.tracking.notification.TrackingForegroundService
    ...
    override fun connectDevice(device: DeviceModel) {
        context.startForegroundService(
            Intent(context, TrackingForegroundService::class.java).apply {
                ...
                putExtra(TrackingForegroundService.EXTRA_DEVICE_ID, device.identifier)
                putExtra(TrackingForegroundService.EXTRA_DEVICE_NAME, device.name)
            }
        )
    }
    ...
    override fun finishTracking(name: String) {
        context.startForegroundService(
            Intent(context, TrackingForegroundService::class.java).apply {
                ...
                putExtra(TrackingForegroundService.EXTRA_ACTIVITY_NAME, name)
            }
        )
    }
