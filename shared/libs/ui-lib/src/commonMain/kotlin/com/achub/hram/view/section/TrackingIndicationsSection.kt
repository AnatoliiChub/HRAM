...
@Composable
fun TrackingIndicationsSection(bleNotification: BleNotificationUi, heartPosUpdated: (Offset) -> Unit) {
...
private fun TrackingIndicationsSectionPreview() {
    val hrNotification = HrNotificationUi(hrBpm = 128, isSensorContactSupported = true, isContactOn = true)
